...
- `alt_text` : str — **필수**. 노션 image caption SEO 추천문. 한국어 80자 이하. line/bar 패턴: "[주제] [기간] 추이, [시작값]에서 [끝값]로 [방향]". donut/pie 패턴: "[주제] [N]개 [축] 구성비, [핵심 slice] 최다". 룰은 `skills/meta/slot_selection.md` "alt_text 룰" 참조. (v1.9 plan §13)
